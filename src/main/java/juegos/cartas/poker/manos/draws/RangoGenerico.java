 ...
 *
 */
public class RangoGenerico<C extends ICartaComparable> implements RangoJugador<C> 
{
	...
	private Carta2ManoRango<C> transformador;
	
	@Override
	public boolean isJuega(List<C> cartas)
	{
		
		ManoRango manoRango = transformador.toManoRango(cartas);
		
		return manos.contains(manoRango);
	}
...
*/
	...
	public List<ManoRango> dameManos()
	{
		return manos;
	}
